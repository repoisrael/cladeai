import{h as o,i as u,s as i}from"./index-T1idvDzn.js";import{u as l}from"./useMutation-DMMqf-nu.js";function p(t){return o({queryKey:["playlists",t],queryFn:async()=>{let r=i.from("playlists").select(`
          *,
