import{g as o,h as u,s as i}from"./index-CeBvdGEW.js";import{u as l}from"./useMutation-BDgd-EOW.js";function p(t){return o({queryKey:["playlists",t],queryFn:async()=>{let r=i.from("playlists").select(`
          *,
