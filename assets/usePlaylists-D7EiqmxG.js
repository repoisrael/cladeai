import{g as o,h as u,s as i}from"./index-DkNgIbaA.js";import{u as l}from"./useMutation-CY0DwmRx.js";function p(t){return o({queryKey:["playlists",t],queryFn:async()=>{let r=i.from("playlists").select(`
          *,
